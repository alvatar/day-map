  ...
  Preloader.prototype = {
    ...
    preload: function () {
      ...
      */
      ...
      this.load.spritesheet('sandals_boy', 'assets/sandals_boy.png', 130, 35)
      ...
      this.load.spritesheet('sandals_girl', 'assets/sandals_girl.png', 130, 35)
      ...
      this.load.spritesheet('jumper_girl', 'assets/jumper_girl.png', 175, 186)
